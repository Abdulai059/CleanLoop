...
export declare const createHousehold: (req: Request, res: Response, next: NextFunction) => void;
export declare const getMyHousehold: (req: Request, res: Response, next: NextFunction) => void;
