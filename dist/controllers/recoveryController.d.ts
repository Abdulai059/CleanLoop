...
export declare const createRecovery: (req: Request, res: Response, next: NextFunction) => void;
export declare const getMyRecoveries: (req: Request, res: Response, next: NextFunction) => void;
