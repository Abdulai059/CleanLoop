...
exports.getMyTransactions = exports.getMyWallet = void 0;
...
exports.getMyWallet = (0, catchAsync_1.catchAsync)(async (req, res, _next) => {
...
exports.getMyTransactions = (0, catchAsync_1.catchAsync)(async (req, res, _next) => {
    const userId = (0, getAuthenticatedUser_1.getAuthenticatedUserId)(req);
