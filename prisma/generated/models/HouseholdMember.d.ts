...
export type GetHouseholdMemberAggregateType<T extends HouseholdMemberAggregateArgs> = {
    [P in keyof T & keyof AggregateHouseholdMember]: P extends '_count' | 'count' ? T[P] extends true ? number : Prisma.GetScalarType<T[P], AggregateHouseholdMember[P]> : Prisma.GetScalarType<T[P], AggregateHouseholdMember[P]>;
};
...
export type GetHouseholdMemberGroupByPayload<T extends HouseholdMemberGroupByArgs> = Prisma.PrismaPromise<Array<Prisma.PickEnumerable<HouseholdMemberGroupByOutputType, T['by']> & {
    [P in ((keyof T) & (keyof HouseholdMemberGroupByOutputType))]: P extends '_count' ? T[P] extends boolean ? number : Prisma.GetScalarType<T[P], HouseholdMemberGroupByOutputType[P]> : Prisma.GetScalarType<T[P], HouseholdMemberGroupByOutputType[P]>;
}>>;
...
export type HouseholdMemberCreateInput = {
    ...
    user: Prisma.UserCreateNestedOneWithoutHouseholdMembershipsInput;
};
...
export type HouseholdMemberUpdateInput = {
    ...
    user?: Prisma.UserUpdateOneRequiredWithoutHouseholdMembershipsNestedInput;
};
...
export type HouseholdMemberOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"householdId" | "userId" | "role" | "joinedAt", ExtArgs["result"]["householdMember"]>;
...
export type HouseholdMemberCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = Omit<HouseholdMemberFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface HouseholdMemberDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
    [K: symbol]: {
        types: Prisma.TypeMap<ExtArgs>['model']['HouseholdMember'];
        meta: {
            name: 'HouseholdMember';
        };
    };
     ...
     * const householdMemberWithHouseholdIdOnly = await prisma.householdMember.findMany({ select: { householdId: true } })
     *
     */
     ...
     * })
     *
     * // Create many HouseholdMembers and only return the `householdId`
     * const householdMemberWithHouseholdIdOnly = await prisma.householdMember.createManyAndReturn({
     ...
     * })
     *
     * // Update zero or more HouseholdMembers and only return the `householdId`
     * const householdMemberWithHouseholdIdOnly = await prisma.householdMember.updateManyAndReturn({
     *   select: { householdId: true },
     *   where: {
     *     // ... provide filter here
     *   },
     ...
     * })
    **/
    count<T extends HouseholdMemberCountArgs>(args?: Prisma.Subset<T, HouseholdMemberCountArgs>): Prisma.PrismaPromise<T extends runtime.Types.Utils.Record<'select', any> ? T['select'] extends true ? number : Prisma.GetScalarType<T['select'], HouseholdMemberCountAggregateOutputType> : number>;
    /**
    ...
    **/
     ...
     *
    **/
    groupBy<T extends HouseholdMemberGroupByArgs, HasSelectOrTake extends Prisma.Or<Prisma.Extends<'skip', Prisma.Keys<T>>, Prisma.Extends<'take', Prisma.Keys<T>>>, OrderByArg extends Prisma.True extends HasSelectOrTake ? {
        ...
        [P in OrderFields]: P extends ByFields ? never : `Error: Field "${P}" in "orderBy" needs to be provided in "by"`;
    }[OrderFields]>(args: Prisma.SubsetIntersection<T, HouseholdMemberGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetHouseholdMemberGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>;
    /**
