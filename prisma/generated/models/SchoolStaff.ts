...
// @ts-nocheck 
/*
 * This file exports the `SchoolStaff` model and its related types.
 *
...
export type GetSchoolStaffAggregateType<T extends SchoolStaffAggregateArgs> = {
      [P in keyof T & keyof AggregateSchoolStaff]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateSchoolStaff[P]>
    : Prisma.GetScalarType<T[P], AggregateSchoolStaff[P]>
}
...
export type GetSchoolStaffGroupByPayload<T extends SchoolStaffGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<SchoolStaffGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof SchoolStaffGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], SchoolStaffGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], SchoolStaffGroupByOutputType[P]>
      }
    >
  >
...
export type SchoolStaffCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<SchoolStaffFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface SchoolStaffDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['SchoolStaff'], meta: { name: 'SchoolStaff' } }
  /**
   ...
   * })
  **/
  count<T extends SchoolStaffCountArgs>(
    args?: Prisma.Subset<T, SchoolStaffCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], SchoolStaffCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends SchoolStaffGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, SchoolStaffGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetSchoolStaffGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
