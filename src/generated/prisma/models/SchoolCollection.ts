...
// @ts-nocheck 
/*
 * This file exports the `SchoolCollection` model and its related types.
 *
...
export type GetSchoolCollectionAggregateType<T extends SchoolCollectionAggregateArgs> = {
      [P in keyof T & keyof AggregateSchoolCollection]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateSchoolCollection[P]>
    : Prisma.GetScalarType<T[P], AggregateSchoolCollection[P]>
}
...
export type GetSchoolCollectionGroupByPayload<T extends SchoolCollectionGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<SchoolCollectionGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof SchoolCollectionGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], SchoolCollectionGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], SchoolCollectionGroupByOutputType[P]>
      }
    >
  >
...
export type SchoolCollectionCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<SchoolCollectionFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface SchoolCollectionDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['SchoolCollection'], meta: { name: 'SchoolCollection' } }
  /**
   ...
   * })
  **/
  count<T extends SchoolCollectionCountArgs>(
    args?: Prisma.Subset<T, SchoolCollectionCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], SchoolCollectionCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends SchoolCollectionGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, SchoolCollectionGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetSchoolCollectionGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
